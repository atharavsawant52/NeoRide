        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>NeoGo <span><i className="ri-user-3-fill"></i>4</span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>NeoAuto <span><i className="ri-user-3-fill"></i>3</span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
            ...
            <div onClick={() => {
                ...
                <img className='h-10' src="https://d1a3f4spazzrp4.cloudfront.net/car-types/haloProductImages/UberXL_Premium.png" alt="NeoXL" />
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>NeoXL <span><i className="ri-user-3-fill"></i>6</span></h4>
